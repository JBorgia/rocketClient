...
import { Supplier } from '@models/ars-app.models';
...
export class SupplierLkupAPI {
    ...
    getAll(): Observable<Supplier[]> {
        return this.http.get<Supplier[]>(`${arsServiceBaseUrl}supplierLkup`, { headers: this.authenticationService.apiGetHeaders() }).pipe(
     ...
     */
    getAllActiveWithName(criteria: String): Observable<Supplier[]> {
        return this.http.get<Supplier[]>(`${arsServiceBaseUrl}supplierLkup/${criteria}`, { headers: this.authenticationService.apiGetHeaders() }).pipe(
