...
import { UserLkupAPI, PartAPI, SupplierLkupAPI } from '@services/index';
...
@Component({
  selector: "app-search-parts-form",
  templateUrl: "./search-parts-form.component.html",
  styleUrls: ["./search-parts-form.component.scss"]
})


export class SearchPartsFormComponent {
  ...
  modalComponentClass = UserFormComponent;
